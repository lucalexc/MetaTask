      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8 relative flex flex-col items-center text-center gap-6"
          >
            <button
              onClick={onClose}
            ...
            <div className="flex flex-col items-center gap-2 mt-2">
              <span className="text-3xl font-black tracking-tight text-slate-900">MetaTask</span>
              <p className="text-slate-500 text-sm leading-relaxed max-w-[220px]">
                Transforme seus objetivos em conquistas reais.
              </p>
            </div>
