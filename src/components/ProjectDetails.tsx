            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-3">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-2 bg-[#202020] text-white text-[13px] font-bold rounded-lg hover:bg-black transition-all ease-out duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm flex items-center justify-center gap-2"
                >
