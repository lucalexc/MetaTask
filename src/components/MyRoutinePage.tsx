...
import { Check, Plus, Loader2, Target, Repeat, Flame, Trophy, Calendar, Settings } from 'lucide-react';
...
function ActivityCard({ activity, onToggle }: { key?: string | number, activity: DailyActivity, onToggle: () => void | Promise<void> }) {
